    ...
    public class MonsterData
    {
        ...
        public MonsterData()
        {
            MonsterTypes = new List<MonsterType>
            {
                ...
                Monster("echo_bat", "울림박쥐", "반향 기관으로 완전한 어둠 속을 비행하는 소형 포식자다.",
                    5, 2, 2, 0, 6, 75, 40,
                ...
                Monster("swamp_water_spirit", "늪귀신", "물길과 젖은 바닥을 영역으로 삼는 습윤 포식자다.",
                    12, 4, 4, 2, 3, 75, 20,
                    Effects(Target("fear", 35), Target("fear", 35), Target("fear", 35), Target("fear", 35)),
                    MonsterFunction.DrainFocus, Skills("water_wail")),
                Monster("echo_mimic", "메아리꾼", "다른 생물의 소리를 복제해 가짜 위치로 먹이를 유인하는 포식자다.",
                    8, 4, 3, 1, 4, 70, 25,
